...
public class LerArquivoHashingCliente {

	// objeto do tipo Scanner para realizar a leitura dos dados do arquivo.
	private Scanner entrada;

	public LerArquivoHashingCliente(String nome) throws FileNotFoundException {
	...
	public EncadeamentoHash lerArquivo(int tamanho) throws NoSuchElementException, ArrayIndexOutOfBoundsException {

		EncadeamentoHash cadastro = new EncadeamentoHash(tamanho);
