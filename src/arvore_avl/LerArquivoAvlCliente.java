...
public class LerArquivoAvlCliente {

	// objeto do tipo Scanner para realizar a leitura dos dados do arquivo.
	private Scanner entrada;

	public LerArquivoAvlCliente(String nome) throws FileNotFoundException {
	...
	public ArvoreAvl lerArquivo(int tamanho) throws NoSuchElementException, ArrayIndexOutOfBoundsException {
